...
Creemos una función llamada `resta_cuadrados` que retorne la resta de los cuadrados de dos números. Luego, evalúa la función en los números 5 y 4 (en ese orden)
...
editar_texto <- function(texto) {
  ...
  texto2 <- str_replace_all(string = texto2, pattern = " ",  replacement = "_")
  texto2
}
...
* Crea una función llamada `estandarizar` que reciba como input un vector y devuelva los valores expresados en desviaciones estándar de la media. Luego, evalúa la función las columnas PESO, TALLA, EDAD_P y EDAD_M crea nuevas variables que contengan la estandarización.  
