...
#editar_nombres(names(proyecciones))
...
proyecciones <- proyecciones %>% 
  mutate(comuna2 = editar_texto(nombre_comuna),
         region2 = editar_texto(nombre_region),
...
Para construir funciones que llaman a funciones de `dplyr`, es necesario usar evaluaciones no estándar (NSE). 
