...
Si alguien se está preguntando cómo podemos combinar el uso de funciones con `dplyr`, será tema de la próxima clase 

--

La combinación de `dplyr` con nuestras propias funciones es una herramienta poderosa para el procesamiento de datos
